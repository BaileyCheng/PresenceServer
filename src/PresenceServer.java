...
public class PresenceServer extends JFrame implements MessageProcessor
{
    private PresenceServerSipLayer sipLayer;
    ...
    public static void main(String[] args)
    {
		...
		try
        {
		    ...
		    PresenceServerSipLayer sipLayer = new PresenceServerSipLayer(username, ip, port);
			PresenceServer tc = new PresenceServer(sipLayer);
    ...
    public PresenceServer(PresenceServerSipLayer sip)
    {
        super();
        sipLayer = sip;
        initWindow();
